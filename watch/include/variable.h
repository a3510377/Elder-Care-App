...
const char HOME_PAGE[] PROGMEM =
    ...
    "head><body><h1>ElderCareWatch Wifi 設定</h1><div style='width: 100%'><div "
    "style='margin: 20px auto; width: 90%; max-width: 800px'><div "
    ...
    "ssidEl=document.getElementById('sl'),event=new "
    "EventSource('/"
    "events');event.addEventListener('wifi_info',(({data:e})=>{ssidEl."
    "innerHTML='',(e=JSON.parse(e)).forEach((({ssid:e})=>{var "
    "n=document.createElement('option');n.value=e,ssidEl.appendChild(n)}))}));<"
    "/script></body></html>";
